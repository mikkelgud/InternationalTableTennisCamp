...
export default function Social(props) {
    ...
    return (
        <StyledDiv>
            ...
            <StyledText>    Every sunday we will use for sightseeing around the city.
             ...
             We will also go to western restaurants, but be ready for everything <span role="img" aria-label="emoji blinking">😉</span>.
             </StyledText>
...
<StyledText>        After every practice, we will have small group talks to sum up the practises.
...
<StyledText>
        ...
        <StyledText>
            ...
            <StyledText>
        It will be a lot of fun! hope to see you in Tao Yuan <span role="img" aria-label="emoji smiling">😊</span>
        </StyledText>
        </StyledDiv>
        )
}