...
export default function Expences(props) {
  ...
  return (
      ...
      <StyledText>
      <ul>
    <li> 2 weeks camp with high quality traning.</li>
    ...
    <li>3 meals every day. <br/>(Notice: If you have any alergies please tell us before the camp).</li>
      ...
      <StyledText>
          ...
          Then you confirm your membership of the camp by sending 7500 Norewegian krones for the flight ticket.
