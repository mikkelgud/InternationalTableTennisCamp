...
export default function loadFontAwesome() {
    library.add(faBars, faComments,faStar, faTimes,faHandshake, faRoute, faDoorClosed, faDoorOpen, faPlaneArrival, faUserShield, faUsers, faHome, faUsersCog, faFacebook, faInstagram);
}
